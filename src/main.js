            ...
            <div class="event__type-list">
              <fieldset class="event__type-group">
                ...
                <div class="event__type-item">
                  ...
                  <label class="event__type-labelevent__type-label--ship" for="event-type-ship-1">Ship</label>
                </div>
                ...
                <div class="event__type-item">
                  ...
                  <label class="event__type-labelevent__type-label--drive" for="event-type-drive-1">Drive</label>
                </div>
              ...
              <fieldset class="event__type-group">
                ...
                <div class="event__type-item">
                  ...
                  <label class="event__type-labelevent__type-label--check-in" for="event-type-check-in-1">Check-in</label>
                </div>
...
render(switchMenuElement, createSwitchMenuTemplate(), `afterend`);
render(filterElement, createFilterTemplate(), `afterend`);
render(softElement, createSortTemplate(), `afterend`);
...
render(tripEventsList, createEditEventTemplate(), `beforeend`);
